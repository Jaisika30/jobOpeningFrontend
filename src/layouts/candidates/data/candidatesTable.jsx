...
//   // Ensure filteredCandidates is updated whenever candidates change.
//   useEffect(() => {
//     setFilteredCandidates(candidates);
//   }, [candidates]);

//   return { candidates: filteredCandidates, setFilteredCandidates, loading: isLoading };
// };

// const getCandidatesTableData = () => {
//   const { candidates, setFilteredCandidates, loading } = useCandidateData();
...
//     if (interviewStatusFilter && interviewStatusFilter !== "") {
//       filteredCandidates = filteredCandidates.filter((candidate) =>
...
//           sx={{ ml: 2 }}
//           style={{ width: "20%", border: "2px solid #2196f3", borderRadius: "8px" }}
//         />
//         <FormControl style={{ width: "20%", border: "2px solid #4caf50", borderRadius: "8px" }}>
...
//           </Select>
//         </FormControl>
//         <FormControl style={{ width: "20%", border: "2px solid #ff9800", borderRadius: "8px" }}>
...
//       ),
//       interviewStatus: (
//         <SoftBadge variant="gradient" badgeContent={candidate.interviewStatus} color="info" size="xs" container />
//       ),
//       status: (
//         <SoftBadge variant="gradient" badgeContent={candidate.status} color="success" size="xs" container />
//       ),
//       action: (
//         <>
