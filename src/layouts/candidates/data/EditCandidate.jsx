            ...
            <form onSubmit={handleSubmit}>
              ...
              >
                <TextField
                  ...
                  onKeyDown={(e) =>
                    e.key === "Enter" && (e.preventDefault(), phoneRef.current?.focus())
                  }
                ...
                <TextField
                  ...
                  onChange={handleChange}
                  onKeyDown={(e) =>
                    e.key === "Enter" && (e.preventDefault(), jobRef.current?.focus())
                  }
              ...
              >
                ...
                <TextField
                  ...
                  label="Time Offered"
                  onKeyDown={(e) =>
                    e.key === "Enter" && (e.preventDefault(), scheduleRef.current?.focus())
                  }
                  InputLabelProps={{ sx: { fontSize: "1rem" } }}
                  sx={textFieldStyles}
                />
                ...
                <TextField
                  ...
                  onChange={handleChange}
                  onKeyDown={(e) =>
                    e.key === "Enter" && (e.preventDefault(), communicationRef.current?.focus())
                  }
                  InputLabelProps={{
                    shrink: true,
                    sx: { fontSize: "1rem" },
                ...
                {[
                  {
                    ...
                    nextRef: personalityRef,
                  },
                  {
                    label: "Personality",
                    name: "personality",
                    ref: personalityRef,
                    nextRef: knowledgeRef,
                  },
                  {
                    label: "Knowledge",
                    name: "knowledge",
                    ref: knowledgeRef,
                    nextRef: interviewStatusRef,
                  },
                ].map(({ label, name, ref, nextRef }) => (
                  <FormControl key={name} sx={{ ...dropdownStyles, position: "relative" }}>
                    <InputLabel id={`${name}-label`} sx={{ ...inputLabelStyle }}>
                      Select {label}
                    </InputLabel>
                    <Box sx={{ display: "flex", alignItems: "center", position: "relative" }}>
                      <Select
              ...
              >
                <FormControl sx={{ ...dropdownStyles, position: "relative" }}>
                  <InputLabel id="interview-status-label" sx={{ ...inputLabelStyle }}>
                  ...
                  <Box sx={{ display: "flex", alignItems: "center", position: "relative" }}>
                    <Select
                      ...
                      onChange={handleChange}
                      onKeyDown={(e) =>
                        e.key === "Enter" && (e.preventDefault(), statusRef.current?.focus())
                      }
                    ...
                    >
                      {["Offered", "Accepted", "Missed", "Interviewed", "Rescheduled"].map(
                        (status) => (
